...
# ---------------------------------------------------------------------
    ...
    def getCurrentPlay(gameLink = ''):
        ...
        with urllib.request.urlopen(apiUrl + gameLink) as request:
            ...
            currentPlay.home.errors = 0 #TODO: playData['liveData']['boxscore']['teams']['home']['teamStats']['batting']['hits']
            ...
            currentPlay.away.errors = 0 #TODO: playData['liveData']['boxscore']['teams']['away']['teamStats']['batting']['hits']
            if currentPlay.status.code == 'F':
